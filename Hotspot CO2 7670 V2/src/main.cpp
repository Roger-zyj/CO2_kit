...
// K30 UART: moved off this board's modem/GPS/SD pins. GPIO16 and GPIO47 are
// only used for the onboard camera header (Y5/Y4), which is unused here -
// they're free as long as you don't have a camera plugged in.
const int K30_RX_PIN = 16;
const int K30_TX_PIN = 47;
